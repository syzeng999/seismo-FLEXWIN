...
!----------------------------------------------------------------------
  ...
  integer :: ier
  ! local parameters
  real ::  synt_sngl(NDIM), obs_sngl(NDIM)
  integer ::  nerr
...
!----------------------------------------------------------------------
  ...
  subroutine check_and_filter_data(ier)
  use seismo_variables
  implicit none
...
!  endif
  ...
  end subroutine check_and_filter_data 
